module short-drama-platform/final-cut-service
...
require (
	...
	short-drama-platform/proto/gen/go v0.0.0
	short-drama-platform/shared v0.0.0
)

replace (
	short-drama-platform/proto/gen/go => ../../proto/gen/go
	short-drama-platform/shared => ../shared/golang
)
