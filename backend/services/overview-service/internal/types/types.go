...
// OverviewService 概览服务接口
type OverviewService interface {
	GetOverview(ctx context.Context, req *OverviewRequest) (*OverviewResponse, error)
	SetOverviewConfig(ctx context.Context, req *SetOverviewConfigRequest) (*SetOverviewConfigResponse, error)
}
