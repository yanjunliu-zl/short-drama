...
type ContentRepository interface {
	...
	// 用户额度
	GetOrCreateCredit(ctx context.Context, userID string) (*model.UserCredit, error)
	DeductCredit(ctx context.Context, userID string, amount int64) (int64, error)
	AddCredit(ctx context.Context, userID string, amount int64) (int64, error)
