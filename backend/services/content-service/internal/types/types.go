...
type ContentService interface {
	...
	SavePipelineStep(ctx context.Context, req *SavePipelineStepRequest) (*PipelineStepResponse, error)
	GetPipelineStep(ctx context.Context, req *GetPipelineStepRequest) (*PipelineStepResponse, error)
...
type PipelineState struct {
	...
	ReferenceImages interface{} `json:"referenceImages,omitempty"`
...
// Per-step pipeline operations — Redis hash backed, atomic single-field reads/writes.
// Valid step names: script, scenes, characters, props, storyboard, videoResults, finalCut

type SavePipelineStepRequest struct {
	WorkID string `path:"id"`
	Step   string `path:"step"`
	// Data is parsed manually from raw body to support both objects and arrays
	Data interface{} `json:"-"`
}

// ParseSavePipelineStepBody manually parses the raw request body for SavePipelineStepRequest
// because go-zero's httpx.Parse cannot handle interface{} for the "data" field
func ParseSavePipelineStepBody(r *http.Request, req *SavePipelineStepRequest) error {
