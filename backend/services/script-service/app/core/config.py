...
class Settings(BaseSettings):
    ...
    # Kafka 配置 — AI 任务异步队列
    TASK_QUEUE_BACKEND: str = os.getenv("TASK_QUEUE_BACKEND", "memory")  # "memory" | "kafka"
    KAFKA_BOOTSTRAP_SERVERS: str = os.getenv("KAFKA_BOOTSTRAP_SERVERS", "kafka:9092")
    KAFKA_CONSUMER_GROUP: str = os.getenv("KAFKA_CONSUMER_GROUP", "ai-workers-script")
    KAFKA_CONSUMER_CONCURRENCY: int = int(os.getenv("KAFKA_CONSUMER_CONCURRENCY", "3"))
