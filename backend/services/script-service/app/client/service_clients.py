...
class LLMServiceClient:
    ...
    async def generate_content(
        ...
        try:
            result = await self.retry_client.post("/api/v1/render/generate", json=payload)
            return result
        except Exception as e:
    ...
    async def generate_image(self, prompt: str, style: str = None) -> Dict[str, Any]:
        ...
        try:
            result = await self.retry_client.post("/api/v1/render/image", json=payload)
            return result
        except Exception as e:
    ...
    async def generate_video(self, image_url: str, prompt: str) -> Dict[str, Any]:
        ...
        try:
            result = await self.retry_client.post("/api/v1/render/video", json=payload)
            return result
        except Exception as e:
